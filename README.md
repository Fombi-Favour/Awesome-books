...
**"Awesome Books" project** is a simple website project that displays a list of books and allows you to add and remove books from that list.
...
```sh
  cd Awesome-books
  git clone git@github.com:Fombi-Favour/Awesome-books.git
```
...
Feel free to check the [issues page](https://github.com/Fombi-Favour/Awesome-books/issues).
...
## 🙏 Acknowledgments <a name="acknowledgements"></a>
  ...
  I would like to thank everybody most especially the Microverse staffs for making it possible to work on the "Awesome books" project.
